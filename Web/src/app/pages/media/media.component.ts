...
constructor(private sanitizer: DomSanitizer) { }
  ...
  ngOnInit() {
    ...
    this.videos = [
      {url: 'https://www.youtube.com/embed/jSJr3dXZfcg'},
      {url: 'https://www.youtube.com/embed/NPD6aOPGlIQ'},
      {url: 'https://www.youtube.com/embed/E4dZYIhjdaM'},
      {url: 'https://www.youtube.com/embed/P5MOhQ-26sM'},
      {url: 'https://www.youtube.com/embed/n5JDOC16bqs'},
      {url: 'https://www.youtube.com/embed/Td0pUwrBWjc'},
    ]
  }
}
